          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to Bluespade.xyz ("we," "us," or "our"), the informational resource for BLU Protocol, as defined below.
              </p>
              <p className="body-text">
                Bluespade.xyz provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the BLU Protocol (the "BLU Protocol," "Protocol," or "BLU DApp"). Bluespade.xyz is not an
              ...
              <p className="body-text">
                ...
                and conditions by which you may access Bluespade.xyz ("the Site") and app.Bluespade.xyz ("the Interface"). Please do
            ...
            <div className="section">
              ...
              <p className="body-text">The Bluespade.xyz site is for informational purposes only.</p>
              <p className="body-text">
                Bluespade.xyz is not part of any transaction on the blockchain networks underlying the BLU Protocol; we do not
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    1.1. As a condition to accessing or using the Site or Interface, you represent and warrant to Bluespade.xyz
                    the following:
                  </p>
                  <ul className="list-style-none">
                    <li>
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over Bluespade.xyz or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that Bluespade.xyz or any of its suppliers or contractors may undertake from time
                        to time; (c) causes beyond Bluespade.xyz's control or that Bluespade.xyz could not reasonably foresee; (d)
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with Bluespade.xyz;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. Bluespade.xyz does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. Bluespade.xyz does not receive fees for any blockchain transactions or using the Site or the Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. Bluespade.xyz own all rights, names, logos, and other marks used on the Site and the Interface,
                    ...
                    Protocol and the Interface (bluespade.xyz) deployed on IPFS is open-sourced. Except as expressly set
                ...
                <li>
                  <p className="body-text">
                    4.2. Bluespade.xyz may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that Bluespade.xyz is free to use or
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. Bluespade.xyz reserve the right, at our sole discretion, from time to time and with or without prior
                    ...
                    own its code. Bluespade.xyz will not be liable for any losses suffered by you resulting from any
                ...
                <li>
                  <p className="body-text">
                    5.2. Bluespade.xyz may revise these Terms from time to time. We will notify you by updating the date at the
                    top of the Terms and maintaining a current version. The most current version of the Terms will
                    always be at https://app.bluespade.xyz/#/terms-and-conditions. All modifications will be effective when they
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. Bluespade.xyz does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That Bluespade.xyz is not responsible for the operation of the open-source software and networks
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither Bluespade.xyz nor any other person or entity will be able to retrieve
                ...
                <li>
                  <p className="body-text">
                    6.2. Bluespade.xyz is not responsible for the content of any third party, including, but not limited to,
                    information, materials, products, or services that Bluespade.xyz does not own or control. In addition,
                    third parties may offer promotions related to your access and use of the Interface. Bluespade.xyz does not
                    ...
                    You expressly relieve Bluespade.xyz of all liability arising from using such resources or participating in
                    such promotions.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that Bluespade.xyz will have no responsibility or liability for the risks
                    in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against Bluespade.xyz, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of Bluespade.xyz;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including Bluespade.xyz's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                Bluespade.xyz is an informational site for the BLU Protocol. Bluespade.xyz does not operate an exchange platform or
              ...
              <p className="body-text">
                You understand that Bluespade.xyz is not registered or licensed by any regulatory agency or authority. No such
                agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. Bluespade.xyz
            ...
            <div className="section">
              ...
              <p className="body-text">
                In no event shall Bluespade.xyz, its affiliates, its suppliers and contractors, and its affiliates', suppliers'
                ...
                or the Interface, or other item provided by or on behalf of Bluespade.xyz, whether under contract, tort
                ...
                or any limited remedy hereunder nor is Bluespade.xyz in any way responsible for the execution or settlement of
                transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall Bluespade.xyz's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless Bluespade.xyz, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                Bluespade.xyz will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to Bluespade.xyz on any of our official channels. The notice must (a) describe the nature and
                basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar in
                form to that described above. If you and Bluespade.xyz cannot reach an agreement to resolve the claim within
                sixty (60) days of your email, then you and Bluespade.xyz agree to resolve the potential dispute according to
              ...
              <p className="body-text">
                ...
                year after such claim arose; otherwise, the claim is permanently barred, which means that you and Bluespade.xyz
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of Bluespade.xyz set forth in these Terms is in addition to, and not in lieu of,
                    any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of Bluespade.xyz in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. Bluespade.xyz will have no responsibility or liability for any failure or delay in performance of the
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and Bluespade.xyz and supersede all prior and
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with Bluespade.xyz
