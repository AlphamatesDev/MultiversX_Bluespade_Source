...
function AssetDropdown({ assetSymbol, assetInfo }) {
  ...
  let { coingecko, cronos, polygon, skale } = ICONLINKS[chainId][assetSymbol] || {};
    ...
    <Menu>
      ...
      <Menu.Items as="div" className="asset-menu-items">
        ...
        <Menu.Item>
          <>
            {cronos && (
              <ExternalLink href={cronos} className="asset-item">
            ...
            {skale && (
              <ExternalLink href={skale} className="asset-item">
                <img src={skaleIcon} alt="Open in explorer" />
                <p>
                  <Trans>Open in Explorer</Trans>
                </p>
              </ExternalLink>
