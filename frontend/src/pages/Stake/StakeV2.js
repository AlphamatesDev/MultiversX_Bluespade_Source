...
import BlueSpadeLogoVideo from 'img/Bluespadelogo.webm';
...
export default function StakeV2({ setPendingTxns, connectWallet }) {
  ...
  const collateralTokenAddress = getContract(chainId, "COLLATERAL_TOKEN");
  const gmxAddress = getContract(chainId, "GMX");
  ...
  const { data: collateralTokenPrice } = useSWR(
    [`StakeV2:collateralTokenPrice:${active}`, chainId, vaultAddress, "getMinPrice", collateralTokenAddress],
    {
  ...
  const { data: gmxSupply } = useSWR(
    [`StakeV2:bluSupply:${active}`, chainId, gmxAddress, "balanceOf", account],
    {
      fetcher: contractFetcher(library, Token),
    }
  );
  ...
  return (
    <div className="default-container StakeV2 page-layout">
      <StakeModal
      ...
      <div className="section-title-block">
        ...
        <video autoPlay loop className='StakeV2-title-img' muted>
          <source src={BlueSpadeLogoVideo} type='video/webm' />
        </video>
      </div>
        ...
        <div className="StakeV2-cards">
          <div className="App-card StakeV2-gmx-card">
            ...
            <div className="App-card-content">
                  ...
                  <Tooltip
                    ...
                    renderContent={() => {
                      return (
                        <>
                          <StatsTooltipRow
                            label={`${nativeTokenSymbol} (${nativeTokenSymbol})`}
                            value={`${formatKeyAmount(
                              processedData,
              ...
              <div className="App-card-options">
                ...
                {active && (
                  <button className="App-button-option App-card-option default-btn" onClick={() => showStakeGmxModal()}>
                    <Trans>Stake</Trans>
                  </button>
                )}
                {active && (
                  <button className="App-button-option App-card-option default-btn" onClick={() => showUnstakeGmxModal()}>
                    <Trans>Unstake</Trans>
                  </button>
                )}
                {active && (
                  <Link className="App-button-option App-card-option default-btn" to="/begin_account_transfer">
            ...
            <div className="App-card-content">
              ...
              <div className="App-card-bottom">
                <div className="App-card-options">
                  {active && (
                    <button
                      className="App-button-option App-card-option default-btn"
                  ...
                  {active && (
                    <button className="App-button-option App-card-option default-btn" onClick={() => setIsClaimModalVisible(true)}>
                      <Trans>Claim</Trans>
                    </button>
                  )}
                  {!active && (
                    <button className="App-button-option App-card-option default-btn" onClick={() => connectWallet()}>
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
                  ...
                  <Tooltip
                    ...
                    renderContent={() => {
                      return (
                        <>
                          <StatsTooltipRow
                            label={`${nativeTokenSymbol} (${nativeTokenSymbol}) APR`}
              ...
              <div className="App-card-options">
                <Link className="App-button-option App-card-option default-btn" to="/buy_blp">
                  <Trans>Buy BLP</Trans>
                </Link>
                <Link className="App-button-option App-card-option default-btn" to="/buy_blp#redeem">
          ...
          <div className="App-card">
            ...
            <div className="App-card-content">
              <div className="App-card-row">
                ...
                <div>${formatAmount(gmxPrice, USD_DECIMALS, 4, true)}</div>
              </div>
              <div className="App-card-row">
                <div className="label">
                  <Trans>Wallet</Trans>
                    ...
                    <Tooltip
                      ...
                      renderContent={() => {
                        return (
                          <>
                            <StatsTooltipRow
                              label={`${nativeTokenSymbol} (${nativeTokenSymbol}) Base APR`}
                              value={`${formatKeyAmount(processedData, "gmxAprForNativeToken", 2, 2, true)}%`}
                              showDollar={false}
                            />
                            {processedData.bnGmxInFeeGmx && processedData.bnGmxInFeeGmx.gt(0) && (
                              <StatsTooltipRow
                                label={`${nativeTokenSymbol} (${nativeTokenSymbol}) Boosted APR`}
                                value={`${formatKeyAmount(processedData, "gmxBoostAprForNativeToken", 2, 2, true)}%`}
                                showDollar={false}
                              />
                            )}
              ...
              <div className="App-card-options">
                {active && (
                  <button className="App-button-option App-card-option default-btn" onClick={() => showStakeEsGmxModal()}>
                    <Trans>Stake</Trans>
                  </button>
                )}
                {active && (
                  <button className="App-button-option App-card-option default-btn" onClick={() => showUnstakeEsGmxModal()}>
                    <Trans>Unstake</Trans>
                  </button>
                )}
                {!active && (
      ...
      <div>
        <div className="Tab-title-section">
          ...
          <div className="Page-description">
            <Trans>
              Convert esBLU tokens to BLU tokens. Please read the{" "}
              <a href="https://bluespadexyz.gitbook.io/bluespade/rewards" target="_blank" rel="noopener noreferrer">
                vesting details
              </a>{" "}
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    {formatKeyAmount(vestingData, "gmxVesterPairAmount", 18, 4, true)} /{" "}
                    {formatAmount(totalRewardTokens, 18, 4, true)}
                  </div>
                </div>
                <div className="App-card-row">
                  <div className="label">
                ...
                <div className="App-card-row">
                  <div className="label">
                    <Trans>Vesting Rate</Trans>
                  </div>
                  <div>
                    {((parseFloat(formatKeyAmount(vestingData, "gmxVesterVestedAmount", 18, 4, true).replace(",", ""))) / 365).toFixed(4)} BLU per day
                  </div>
                </div>
                <div className="App-card-row">
                  <div className="label">
            ...
            <div className="App-card StakeV2-gmx-card">
              ...
              <div className="App-card-content">
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    {formatKeyAmount(vestingData, "glpVesterPairAmount", 18, 4, true)} /{" "}
                    {formatAmount(processedData.glpBalance, 18, 4, true)}
                  </div>
                </div>
                <div className="App-card-row">
                  <div className="label">
                ...
                <div className="App-card-row">
                  ...
                  <div>
                    {((parseFloat(formatKeyAmount(vestingData, "glpVesterVestedAmount", 18, 4, true).replace(",", ""))) / 365).toFixed(4)} BLU per day
                  </div>
                </div>
                <div className="App-card-row">
                  <div className="label">
