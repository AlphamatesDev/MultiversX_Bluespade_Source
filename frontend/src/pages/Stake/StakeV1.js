...
export default function StakeV1() {
  ...
  const collateralTokenAddress = getContract(CHAIN_ID, "COLLATERAL_TOKEN");
  ...
  const buyAutoUrl = `https://exchange.pancakeswap.finance/#/swap?outputCurrency=${autoAddress}&inputCurrency=${collateralTokenAddress}`;
  ...
  return (
    <div className="Stake Page page-layout">
      ...
      <div className="App-warning Stake-warning">
        <Trans>
          The <Link to="/migrate">BLU migration</Link> is in progress, please migrate your GMT, xGMT, GMT-USDG and
          xGMT-USDG tokens.
          <br />
