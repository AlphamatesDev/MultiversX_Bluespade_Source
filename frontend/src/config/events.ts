...
export const appEventsData: EventData[] = [
  ...
  //     {
  //       text: "Read more",
  //       link: "https://bluespadexyz.gitbook.io/bluespade/roadmap#30-march-2022",
  //       newTab: true,
  //     },
  //     {
  //       text: "Trade Now",
  ...
  //     {
  //       text: "Learn More",
  //       link: "https://bluespadexyz.gitbook.io/bluespade/trading#backup-rpc-urls",
  //       newTab: true,
  //     },
  //   ],
  // },
  ...
  //     {
  //       text: "Read More",
  //       link: "https://bluespade.medium.com//gmx-arbitrum-odyssey-fc12cba2d10d",
  //     },
  //   ],
  // },
  // {
  ...
  //     {
  //       text: "Read More",
  //       link: "https://bluespade.medium.com//gmx-frontend-updates-8d13f2346e1e",
  //       newTab: true,
  //     },
  //   ],
  // },
  ...
  //     {
  //       text: "Read More",
  //       link: "https://bluespade.medium.com//arbitrum-nitro-5f88c03a46fe",
  //       newTab: true,
  //     },
  //   ],
  // },
  ...
  //     {
  //       text: "Read More",
  //       link: "https://bluespade.medium.com//gmx-deployment-updates-a6a470df445f",
  //       newTab: true,
  //     },
  //   ],
  // },
