...
const chartOverrides = {
  ...
  "paneProperties.backgroundGradientStartColor": "#070707",
  "paneProperties.backgroundGradientEndColor": "#070707",
  ...
  "scalesProperties.lineColor": "#070707",
  ...chartStyleOverrides,
};
...
export const defaultChartProps = {
  ...
  loading_screen: { backgroundColor: "#070707", foregroundColor: "#2962ff" },
  favorites: {},
  custom_formatters: {
    timeFormatter: {
...
export const availableNetworksForChart = [SKALE];
