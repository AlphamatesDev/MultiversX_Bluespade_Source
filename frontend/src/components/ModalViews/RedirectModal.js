  ...
  return (
    ...
    >
      ...
      <Trans>
        ...
        <br />
        <br />
        By clicking Agree you accept the <ExternalLink href="https://app.bluespade.xyz/#/terms-and-conditions">
          T&Cs
        </ExternalLink>{" "}
        and <ExternalLink href="https://app.bluespade.xyz/#/referral-terms">Referral T&Cs</ExternalLink>.
        <br />
        <br />
      </Trans>
      <div className="mb-sm">
      ...
      <a className="App-cta Exchange-swap-button"  href={appRedirectUrl} onClick={() => onClickAgree()}>Agree</a>
    </Modal>
  );
}
