    ...
    <>
      ...
      <header>
        <div className="App-header large">
          {/* <div className={`Header-gradient-bg-${mode}`}></div> */}
          <div className="App-header-container-left">
            <a href="https://www.bluespade.xyz" className="App-header-link-main" target="_self" rel="noopener noreferrer">
            {/* <Link className="App-header-link-main" to="/"> */}
              <img src={logoImg} className="big" alt="BLU Logo" />
              <img src={logoSmallImg} className="small" alt="BLU Logo" />
            {/* </Link> */}
