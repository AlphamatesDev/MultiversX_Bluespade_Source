...
import SuperGlpRewards from "pages/SuperGlpRewards/SuperGlpRewards";
import Bluebet from "pages/Bluebet/Bluebet";
        ...
        <div className="App-content">
          ...
          {!isHome && (
            <Switch>
              ...
              <Route exact path="/super_blp_rewards">
                <SuperGlpRewards
                  savedSlippageAmount={savedSlippageAmount}
                  setPendingTxns={setPendingTxns}
                  connectWallet={connectWallet}
