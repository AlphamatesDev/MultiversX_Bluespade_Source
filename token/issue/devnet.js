...
async function main() {
    ...
    const networkConfig = await proxyNetworkProvider.getNetworkConfig();
    ...
    const senderOnNetwork = await proxyNetworkProvider.getAccount(senderAddress)
    ...
    const watcher = new TransactionWatcher(proxyNetworkProvider);
