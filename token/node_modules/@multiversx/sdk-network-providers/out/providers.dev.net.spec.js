...
describe("test network providers on devnet: Proxy and API", function () {
    ...
    let apiProvider = new apiNetworkProvider_1.ApiNetworkProvider("https://devnet-api.multiversx.com", { timeout: 10000 });
    let proxyProvider = new proxyNetworkProvider_1.ProxyNetworkProvider("https://devnet-gateway.multiversx.com", { timeout: 10000 });
